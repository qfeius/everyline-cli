...
for skill_name in everyline-cli everyline-review everyline-review-config; do
  ...
  diff -r "$global_package_root/@qfeius/everyline-cli/skills/$skill_name" "$doubao_skills_dir/$skill_name"
  node - "$codex_skill_target" "$workbuddy_skill_target" "$global_package_root/@qfeius/everyline-cli/skills/$skill_name" <<'NODE'
...
node - "$global_config_dir" "$codex_skills_dir" "$workbuddy_skills_dir" "$global_package_root/@qfeius/everyline-cli" <<'NODE'
...
npm_config_global=true EVERYLINE_CONFIG_DIR="$global_config_dir" EVERYLINE_CODEX_SKILLS_DIR="$codex_skills_dir" EVERYLINE_WORKBUDDY_SKILLS_DIR="$workbuddy_skills_dir" EVERYLINE_DOUBAO_SKILLS_DIR="$doubao_skills_dir" node "$global_package_root/@qfeius/everyline-cli/scripts/install.js" > "$temporary_dir/upgrade.txt"
